			...
			<div className="w-11/12 lg:w-10/12 xl:w-9/12 2xl:w-8/12 max-width flex justify-between">
				...
				<div className="flex space-x-8 items-center">
					...
					<a className="absolute right-14 sm:static top-5 transform translate-x-1 sm:translate-none" href="https://github.com/sleeptil3" target="_blank" rel="noopener noreferrer">
						<svg className="h-6 sm:h-auto text-white fill-current hover:text-primary transition-colors duration-200" width="33" height="32" viewBox="0 0 33 32" xmlns="http://www.w3.org/2000/svg">
					...
					<Link to="/info" className="absolute top-14 right-4 sm:static focus:outline-none focus:ring-0 bg-primary px-2 py-1 sm:px-3 sm:py-2 text-xs md:text-md tracking-wide hover:bg-white">Hire Me</Link>
				</div>
			</div>
		</header>
	)
