...
export default function Footer() {
	...
	return (
		<footer className="relative z-10 w-screen py-24 space-y-2 flex flex-col items-center justify-center bg-black text-white tracking-wide">
			...
			<div>
				<h1 className="font-semibold text-lg tracking-wide text-center">Shawn Clary</h1>
			</div>
			...
			<div className="absolute left-40 opacity-50 z-0">
				<img className="w-2/6 relative left-10 top-4 filter blur-3xl" src={blurbox1} alt="" />
				<img className="w-2/6 relative bottom-8 left-72 filter blur-2xl" src={blurbox2} alt="" />
			</div>
			<div className="absolute right-40 bottom-3 z-0">
				<img className="w-2/6 relative left-48 filter blur-2xl" src={blurbox4} alt="" />
				<img className="w-1/2 relative bottom-4 left-7 filter blur-xl" src={blurbox3} alt="" />
			</div>
		</footer>
	)
}
