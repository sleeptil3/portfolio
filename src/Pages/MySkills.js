		...
		<div className="flex justify-center items-center mb-10 sm:mb-20 sm:mt-32">
			<div className="relative flex flex-col sm:flex-row mt-8 sm:mt-0 sm:justify-center sm:items-center h-full w-11/12 lg:w-10/12 xl:w-9/12 2xl:w-8/12 max-width sm:px-10">
				...
				<div className="absolute right-0 top-0 sm:top-40 z-0 flex-grow-0 opacity-50 transform scale-50 sm:transform-none">
					...
					<img data-aos="fade-left" className="relative left-32 -top-48 sm:top-0 sm:left-10" src={blurbox1} alt="" />
					<img data-aos="fade-right" className="relative bottom-80 sm:bottom-44 right-24 sm:right-20 opacity-50 sm:opacity-100" src={blurbox2} alt="" />
				</div>
				{/* END BLUR BOX */}
			</div>
		</div>
