...
export default function MyWork() {
	...
	return (
		<div id="top" className="flex flex-col relative w-screen overflow-hidden">
			...
			{/* FEATURED PROJECT */}
			<div id="featured" className="relative mx-auto sm:w-11/12 xl:w-9/12 sm:px-10 md:px-0 lg:px-10 2xl:px-20 max-width md:h-screen mb-20 sm:mb-56 md:mt-0">
				<div className="flex flex-col items-center justify-center">
					...
					<p>Launching August 30, 2021</p>
					<img className="mt-5" alt="Download from the Apple AppStore" src={appstore} />
				</div>
				<div className="mt-4 relative flex md:flex-row flex-col-reverse justify-around xl:justify-between items-center">
					<div data-aos="fade-right" className="mt-10 sm:mt-0 relative z-10 flex flex-col space-y-6 w-10/12 md:w-1/2 lg:w-1/2 pr-4 lg:pr-20 xl:pr-28">
						...
						<p className="text-sm">Join an AI teammate against two AI opponents for nights of endless fun.</p>
						<p className="text-sm">Included are multiple custom-designed, retina-quality themes for when you want to change things up.
						</p>
						<p className="text-gray-400 text-sm font-bold tracking-wide">#ReactNative #iOS #AI #GameDesign</p>
						<div className="flex space-x-2">
							<a className="text-gray-500" href="https://testflight.apple.com/join/nyUstrpN" target="_blank" rel="noopener noreferrer">JOIN THE BETA</a>
						...
						<div data-aos-offset="200" data-aos="fade" className="hidden sm:flex justify-center items-center pt-10">
					...
					<div data-aos="zoom-in-left" className="w-10/12 mt-20 xl:mt-6 mb-10 md:mb-0 md:w-1/2 relative z-10 lg:left-14">
						<img src={euchre} alt="" />
					</div>
				</div>
			</div>
			...
			{features.map(feature => {
				return (
					<div key={uuid()} className="relative bg-black mb-20 sm:mb-48 lg:mb-64 py-4">
